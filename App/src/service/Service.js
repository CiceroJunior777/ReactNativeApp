...
export default class Db {
    ...
    //método que irá adicionar o cliente ao banco
    addCliente(cliente) {
        let db;
        SQLite.openDatabase(
            database_name,
    ...
    //Método que irá Atualizar os dados do Cliente no Banco
    ...
    //Método que fará a exclusão do Cliente no Banco de Dados
